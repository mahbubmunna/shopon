...
import 'package:sunbulahome/src/FlutterProvider/BestSellingProvider.dart';
...
import 'package:sunbulahome/src/FlutterProvider/ProfileProvider/NewLaunchesProvider.dart';
...
import 'package:sunbulahome/src/widgets/BrandsIconsCarouselWidget.dart';
import 'package:sunbulahome/src/widgets/CategoriesIconsCarouselWidget.dart';
import 'package:sunbulahome/src/widgets/CategorizedProductsWidget.dart';
import 'package:sunbulahome/src/widgets/FlashSalesCarouselWidget.dart';
import 'package:sunbulahome/src/widgets/FlashSalesWidget.dart';
...
import 'package:sunbulahome/src/widgets/bestSellWidgets.dart';
...
class _HomeWidgetState extends State<HomeWidget> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
...
*/
  ...
  void initState() {
    ...
    _home_scroll_controller = new ScrollController(keepScrollOffset: true)
      ..addListener(() {
        ...
        FutureBuilder(
          ...
          builder: (context, AsyncSnapshot<List<Product>> bestSell) {
            return bestSell.data != null
                ? Container(
                    height: 300,
                    child: BestSellList(bestSell: bestSell,)
                  )
                : Container(
                    height: 300,
                    child: ListView.builder(
